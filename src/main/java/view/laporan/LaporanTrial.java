 ...
 * @author laptop
 */
public final class LaporanTrial extends javax.swing.JInternalFrame {
...
//    private List<PeminjamanDetail> daftarPeminjamanDetail = new ArrayList<>();
     ...
     */
    public LaporanTrial(MainMenu mainMenuController) {
        initComponents();
...
//        refresDataKategoriAset();
    ...
    private void initComponents() {
        ...
        txtKepemilikan.setMaximumSize(new java.awt.Dimension(90, 29));
        txtKepemilikan.setMinimumSize(new java.awt.Dimension(90, 29));
        txtKepemilikan.setPreferredSize(new java.awt.Dimension(90, 29));
        ...
        tableView.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "No Trial", "Tanggal", "Produk", "Mesin", "Ka Shift", "Operator", "Mulai", "Selesai"
            }
        ) {
        ...
        if (tableView.getColumnModel().getColumnCount() > 0) {
            ...
            tableView.getColumnModel().getColumn(6).setPreferredWidth(70);
            tableView.getColumnModel().getColumn(6).setMaxWidth(70);
...
//            Logger.getLogger(LaporanTrial.class.getName()).log(Level.SEVERE, null, ex);
//        }
    }
